...
<body>
    ...
    <main>
      ...
      <!-- <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="">
          ...
          <div class="carousel-inner" style="height:60vh; margin-top:0; padding:0;">
              <div class="carousel-item active">
                  <img class="d-block w-100" src="../assets/images/Lab and Staff/TESTTUBES-03.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                  <img class="d-block w-100" src="../assets/images/Lab and Staff/ACCESSIONING-03.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                  <img class="d-block w-100" src="../assets/images/Lab and Staff/INSTRUMENT-05.jpg" alt="Third slide">
              </div>
  
              <div class="carousel-item">
                  <img class="d-block w-100" src="../assets/images/Lab and Staff/PRODUCTION-INTHELAB.jpg" alt="Fourth slide">
              </div>
          </div>
